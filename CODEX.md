---
document_id: CODEX
title: Codex Compatibility Instructions
spec_version: 3.0
...
Maintain compatibility with OpenAI Codex / GPT code agents while executing the CMMI Blog AI Specification. Architecture is identical to [AGENTS.md](AGENTS.md).
...
4. Resolve any required module by Rule ID range.

## Execution

Follow [10_EXECUTION_PIPELINE.md](specification/10_EXECUTION_PIPELINE.md). Stages are deterministic and non-skippable (RULE-10010).
